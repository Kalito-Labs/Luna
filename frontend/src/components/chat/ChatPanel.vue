...
.chat-input:focus {
  border-color: rgba(66, 93, 245, 0.5);
...
.primary-button {
  background: linear-gradient(135deg, rgba(9, 42, 70, 0.9) 0%, rgba(17, 61, 90, 0.9) 100%);
...
.primary-button:hover {
  background: linear-gradient(135deg, rgb(22, 59, 90) 0%, rgb(28, 90, 131) 100%);
